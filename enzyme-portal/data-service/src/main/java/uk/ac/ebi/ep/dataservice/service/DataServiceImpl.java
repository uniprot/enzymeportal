...
public class DataServiceImpl implements DataService {
    ...
    @Transactional(readOnly = true)
    @Override
    public List<ProteinView> findProteinViewByRelatedProteinIdAndProteinGroupId(Long relId, String proteinGroupId) {
        return uniprotEntryRepository.findProteinViewByRelatedProteinsIdAndProteinGroupId(relId, proteinGroupId);
    }
    ...
    public ProteinData findProteinByAccession(String accession) {
        return uniprotEntryRepository.findProteinByAccession(accession);
    }
