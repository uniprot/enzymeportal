<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
	import="java.util.EnumSet,
                uk.ac.ebi.ep.literatureservice.transferObjects.CitationLabel"%>
	...
	<c:when test="${empty enzymeModel.literature}">
		 <%-- 
			...
			arguments="literature"/></p>
                 --%>
                 <p class="noResults">No Literature found for this enzyme</p>
	</c:when>
	<c:otherwise>
...
<!--            <div class="literature" style="position: relative; width: 100%; top: 10ex;">-->
 <div class="literature" style="width: 100%; top: 10ex;">
...
<div id="citationsList" style="padding-top: 5em;">
...
<div id="literatureFilters" class="subTitle"
    ...
    <c:if test="${fn:length(enzymeModel.literature)
        ...
        href="http://europepmc.org/search/?page=1&query=UNIPROT_PUBS:${enzymeModel.accession}" target="_blank">
        See more in EPMC...</a>
    </c:if>
    </span>
...
<div class="provenance">
	<ul>
		<li class="note_0">Data Source:
			<a href="https://europepmc.org/search/?page=1&query=UNIPROT_PUBS:${enzymeModel.accession}" target="_blank">Europe PMC</a></li>
