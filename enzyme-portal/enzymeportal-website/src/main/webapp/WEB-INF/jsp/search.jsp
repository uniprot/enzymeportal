            ...
            <div id="content" role="main" class="clearfix" >
                ...
                <div class="row" id="title-row">
                    ...
                    <section class="large-10 columns">
                        ...
                        <h4>${ebiResult.hitCount} associated proteins found for "${searchKey}" with EC ${ec}</h4>
                    </section>
                </div>
                ...
                <div class="row">
                    ...
                    <section id="search-filters" class="large-3 columns">
                        ...
                        --%>
                        <form id="facetFilterForm" action="${pageContext.request.contextPath}/search" modelAttribute="searchModel" method="POST">
                            ...
                            <form:hidden path="searchparams.text" value="${searchKey}" />
                             <input type="hidden" id="searchIdXXX" name="searchIdOLD" value="${searchId}"/>
                            --%>
                ...
                <c:when test="${keywordType eq 'METABOLITES' || keywordType eq 'PATHWAYS' || keywordType eq 'FAMILIES'}">
                    <script>
                        $(document).ready(function () {
                            ...
                            var input = $("<input>")
                                    .attr("type", "hidden")
                                    .attr("name", "searchId").val(resourceId);
                            $('#facetFilterForm').append($(input));
