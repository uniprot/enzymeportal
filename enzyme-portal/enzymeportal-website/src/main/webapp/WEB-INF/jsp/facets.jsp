    ...
    <c:if test="${facet.id eq 'OMIM'}">
        <div class="sublevel1">
            ...
            <ul>
                ...
                <div id="diseasesList">
                    <c:forEach var="v" items="${facet.facetValues}">
                        <li><input id="OMIM_${v.value}" name="filterFacet" value="OMIM:${v.value}" type="checkbox" onChange="this.form.submit()"> ${v.label} <span class="facetCountXX">(${v.count})</span></li>
                        </c:forEach>
                </div>
            </ul>
        </div>
    ...
    <c:if test="${facet.id eq 'enzyme_family'}">
        <div class="sublevel1">
            ...
            <ul>
                <div id="enzymeList">
                    <c:forEach var="v" items="${facet.facetValues}">
                        <li><input id="enzyme_family_${v.value}" name="filterFacet" value="enzyme_family:${v.value}" type="checkbox" onChange="$('#facetFilterForm').submit()"> ${v.label} (${v.count})</li>
                        </c:forEach>
                </div>
            </ul>
        </div>
