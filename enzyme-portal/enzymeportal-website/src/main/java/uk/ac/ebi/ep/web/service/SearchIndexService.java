...
public interface SearchIndexService {
    ...
    ProteinGroupSearchResult findAssociatedProtein(String query, int pageSize);

    ProteinGroupSearchResult findProteinResult(String query, int startPage, int pageSize, int facetCount, List<String> facetList);
