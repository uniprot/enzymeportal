...
public class IntenzSaxParser extends DefaultHandler implements EbinocleParser {
    ...
    public IntenzSaxParser(EnzymePortalCompoundRepository repository, EnzymeSummaryRepository summary, ReactionRepository reactionRepo) {
        this.compoundRepository = repository;

        this.enzymeSummaryRepository = summary;
            ...
            if (summaryList != null && !summaryList.isEmpty()) {
                for (EnzymeSummary summary : summaryList) {
                    ...
                    if (rheaEntry != null) {
                        ...
                        reaction.setUniprotAccession(summary.getAccession());
                    ...
                    for (EnzymePortalCompound reactant : reactants) {
                        ...
                        chebiEcXref.setUniprotAccession(summary.getAccession());
                        chebiEcXref.getReactionSet().add(reaction_per_ec);
