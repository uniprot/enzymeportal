...
----------------------------
  CREATE TABLE IF NOT EXISTS PRIMARY_PROTEIN
   (	RELATED_PROTEINS_ID NUMBER(15,0), 
	...
	PDB_ID VARCHAR2(10),
        ...
        PDB_SPECIES VARCHAR2(255), 

 CONSTRAINT PRIMARY_PROTEIN_FK1 FOREIGN KEY (RELATED_PROTEINS_ID) REFERENCES RELATED_PROTEINS (REL_PROT_INTERNAL_ID)
   );
