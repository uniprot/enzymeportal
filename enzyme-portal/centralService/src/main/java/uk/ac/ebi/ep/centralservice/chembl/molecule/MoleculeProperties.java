...
public class MoleculeProperties {
    ...
    /**
     *
     * @param acdMostApka The acd_most_apka
     */
    @JsonProperty("acd_most_apka")
    ...
    /**
     *
     * @param acdMostBpka The acd_most_bpka
     */
    @JsonProperty("acd_most_bpka")
    ...
    /**
     *
     * @param aromaticRings The aromatic_rings
     */
    @JsonProperty("aromatic_rings")
    ...
    /**
     *
     * @param fullMolformula The full_molformula
     */
    @JsonProperty("full_molformula")
    ...
    /**
     *
     * @param heavyAtoms The heavy_atoms
     */
    @JsonProperty("heavy_atoms")
    ...
    /**
     *
     * @param medChemFriendly The med_chem_friendly
     */
    @JsonProperty("med_chem_friendly")
    ...
    /**
     *
     * @param molecularSpecies The molecular_species
     */
    @JsonProperty("molecular_species")
    ...
    /**
     *
     * @param mwFreebase The mw_freebase
     */
    @JsonProperty("mw_freebase")
    ...
    /**
     *
     * @param mwMonoisotopic The mw_monoisotopic
     */
    @JsonProperty("mw_monoisotopic")
    ...
    /**
     *
     * @param numAlerts The num_alerts
     */
    @JsonProperty("num_alerts")
    ...
    /**
     *
     * @param numRo5Violations The num_ro5_violations
     */
    @JsonProperty("num_ro5_violations")
    ...
    /**
     *
     * @param qedWeighted The qed_weighted
     */
    @JsonProperty("qed_weighted")
