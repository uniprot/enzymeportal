...
/**
* 
* @param assaySubcellularFraction
* The assay_subcellular_fraction
*/
@JsonProperty("assay_subcellular_fraction")
...
/**
* 
* @param assayTypeDescription
* The assay_type_description
*/
@JsonProperty("assay_type_description")
...
/**
* 
* @param confidenceDescription
* The confidence_description
*/
@JsonProperty("confidence_description")
