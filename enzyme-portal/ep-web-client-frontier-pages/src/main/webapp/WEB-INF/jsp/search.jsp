                    ...
                    <script type="text/javascript">
                        ...
                        $(document).ready(function(){
                            ...
                            $("#autoCheckBox").click(function () {
                                //        $("#filtersForm").submit();
                                //$('input:checkbox[name=searchparams.species]').attr('checked',false);
                                $("#filtersForm").submit();
                                ...
                                <div class="filter" style="width: 25%; float: left;">                    
                                    ...
                                    <form:form id="filtersForm" name="filtersForm" modelAttribute="searchModel" action="search" method="POST">
                                        ...
                                        <div class="sublevel1"> 
                                            ...
                                            <c:if test="${fn:length(searchFilter.species) gt 10}">           
                                            ...
                                            <div>
                                                    <c:forEach var="i" begin="0" end="${limitedDisplay-1}">
                                                        <c:if test='${not empty speciesList[i].scientificname}'>
                                                            ...
                                                            <c:if test="${speciesList[i].selected eq true }">     
                                                    ...
                                                    <c:if test='${(checkedItems gt 0)}'><hr/></c:if>

                                                        <!--                   end display only checked items -->



                                                        <!--    display all other unchecked items -->
                                                    ...
                                                    <c:forEach var="i" begin="0" end="${limitedDisplay-1}"> 
                                                        ...
                                                        <c:if test='${not empty speciesList[i].scientificname }'>
                                                            ...
                                                            <c:if test='${(speciesList[i].selected eq false )}'>                                   
        ...
        $( "#specieAT" ).autocomplete({
            ...
            select: function( event, ui ) {
                ...
                return true;
                                                    ...
                                                    <!--end display all other unchecked items-->
                                                ...
                                                <c:if test="${compoundListSize > 0}">
                                                    ...
                                                    <div >
                                                        ...
                                                        <c:forEach var="c" begin="0" end="${limitedDisplay-1}">
                                                            ...
                                                            <c:if test='${(compoundList[c].selected eq true )}'> 
                                                                <c:set var="checkedItems" value="${checkedItems + 1}"/> 
                                                                <div class="filterLine">
                                                                    <div class="text">
                                                                        <xchars:translate>
                                                    ...
                                                    <c:forEach var="c" begin="0" end="${limitedDisplay-1}">
                                                        <c:if test='${(compoundList[c].selected eq false )}'> 
                                                            <div class="filterLine">
                                                                <script>
                                                                    $(function()  {
                                        ...
                                        <div class="sublevel1" >
                                            ...
                                            <div class="filterContent">
                                                ...
                                                <c:if test="${diseasesListSize > 0}">
                                                    ...
                                                    <div >
                                                        <c:set var="checkedItems" value="0"/> 
                                                        <c:set var="UncheckedItems" value="0"/> 
                                                        <c:forEach var="d" begin="0" end="${diseasesLimitedDisplay-1}">
                                                            <c:if test='${(diseasesList[d].selected eq true )}'> 
                                                                <c:set var="checkedItems" value="${checkedItems + 1}"/>
                                                                <div class="filterLine">
                                                                    <div class="text">
                                                                        <xchars:translate>
                                                            ...
                                                            <!--                 this is to ensure that the line is not showing when all disease are selected.
                                                                             this is useful when a few number of result is found.-->
                                                            <c:if test='${(diseasesList[d].selected eq false )}'> 
                                                                <c:set var="UncheckedItems" value="${fn:length(diseasesList)}"/>
                                                            </c:if>
                                                        </c:forEach>

                                                    </div> 

                                                    <c:if test='${(checkedItems gt 0) and UncheckedItems >0}'><hr/></c:if>                  
