                ...
                <div id="local-masthead" class="masthead grid_24 nomenu">
                    ...
                    <nav>
                        <ul class="grid_24" id="local-nav">
                            ...
                            <li class="last active"><a href="${pageContext.request.contextPath}/browse" title="Browse Disease">Browse Disease</a></li>
                    ...
                    <div class="grid_24">
                            ...
                            <div class="grid_6">
                                ...
                                <ul>
                                    ...
                                    <c:if test="${count gt maxDisplay}">
                                        <span><a href="${pageContext.request.contextPath}/browse/<c:out value="${startsWith}"/>">view all </a>${startsWith}</span>
                                    </c:if>
                                    <c:set var="count" value="0"/>
                                </ul>
                                ...
                                <ul>
                                    ...
                                    <c:if test="${stop eq false}">
                                        <c:forEach var="data" items="${diseaseList}"> 
                                            ...
                                            <c:choose>
                                                <c:when test="${Fn:startsWithLowerCase(data.name, startsWith) && count <= maxDisplay}">
                                                    <c:set var="count" value="${count + 1}"/>
                        ...
                        <div class="grid_24">
                            ...
                            <div class="grid_6 hidden">
                                <c:set var="startsWith" value="Numbers"/>
                                <h3>${fn:toLowerCase(startsWith)}</h3>
                                <ul>
                                    <c:forEach var="data" items="${diseaseList}"> 

                                        <c:if test="${Fn:startsWithDigit(data.name) && count <= maxDisplay}">
                                            <c:set var="count" value="${count + 1}"/>
