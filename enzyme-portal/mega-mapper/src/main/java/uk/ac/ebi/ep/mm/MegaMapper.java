...
public interface MegaMapper {
    ...
    public enum Constraint {
        ...
        EQUALS, STARTS_WITH, CONTAINS, ENDS_WITH
    }
     ...
     * @return a collection of xrefs in the map, regardless of the database.
     * Note that the entry used in the query may be either the origin or the
     * target of an xref.
     */
     ...
     * @return a collection of xrefs in the map. Note that the entry used in the
     * query may be either the origin or the target of an xref.
     */
     ...
     * @return a collection of xrefs in the map. Note that the entries used in
     * the query may be either the origin or the target of an xref.
     */
     ...
     * ID) regardless of the referencing/referenced database..
     *
     * @param db the database where the accession is from.
     * @param accession the accession number.
     * @return a collection of xrefs in the map. Note that the accession used in
     * the query may be either the origin or the target of an xref.
     */
    ...
    /**
     * Retrieves cross references from the mega-map for a given accession (not
     * ID) to/from the given database(s).
     *
     * @param db the database where the accession is from.
     * @param accession the accession number.
     * @param xDb the referencing/referenced database(s).
     * @return a collection of xrefs in the map, or <code>null</code> if none
     * found. Note that the accession used in the query may be either the origin
     * or the target of an xref.
     */
    public Collection<XRef> getXrefs(MmDatabase db, String accession,
            MmDatabase... xDb);
     ...
     * matches an entry ID, who has a given relationship (if any).<br> This
     * method is provided in order to search for UniProt ID prefixes (ex.
     ...
     * underscore (_) character, so that "DHSA" won't return xrefs for "DHSA1".
     ...
     * <code>null</code>).
     * @return a collection of xrefs in the map, or <code>null</code> if none
     * found. Note that the entries corresponding to the query may be either the
    ...
    /**
     * Retrieves cross references from the mega-map for a given text which
     * matches an entry ID, who is related to the given databases.<br> This
     * method is provided in order to search for UniProt ID prefixes (ex.
     * "CFTR_") but can be used for other purposes as well.
     *
     * @param db the Database providing IDs matching <code>idFragment</code>. If
    ...
    /**
     * Retrieves Entries from the mega-map for a given accession where database
     * name is CheMBL. (not ID).
     *
     * @param db the database where the accession is from.
     * @param accession the accession number.
     * @param xDb the referencing/referenced database(s).
     * @return a List of entries in the map, or <code>null</code> if none found.
     * Note that the accession used in the query may be either the origin or the
     * target of an xref.
     */
     ...
     * activators, inhibitors, cofactors, drugs, bioactive compounds, reaction
     * participants - or <code>null</code> if none found.
     */
