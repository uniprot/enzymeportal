                ...
                <c:choose>
                    ...
                    <c:when test="${fn:startsWith(hItem, 'searchparams.text=')}">
                        <c:if test="${not Fn:lastInList(history, hItem)}">
                            ...
                            <a href="${pageContext.request.contextPath}/enzymes?searchparams.type=KEYWORD&${hItem}&searchKey=${Fn:splitAndGetValue(hItem)}&searchparams.start=0&searchparams.previoustext=">Search
