...
enzymeApp.controller('TypeAheadController',['$scope','$http','$location',
    function($scope, $http, $location){
        ...
        $scope.onSelectPathways = function($model) {
            ...
            var url = '/enzymeportal/search-pathways?entryid=' 
            + id 
            + '&entryname=' 
            + name 
            + '&AMP;searchparams.type=KEYWORD&searchparams.previoustext=' 
            + name 
        ...
        $scope.onSelectDiseases = function($model) {
            ...
            $scope.selectedItem = $model;
            var url = '/enzymeportal/search-disease?entryid=' 
            + id 
            + '&entryname=' 
            + name 
            + '&AMP;searchparams.type=KEYWORD&searchparams.previoustext=' 
            ...
            draw = function(data){
                ...
                node.append("a")
                    .attr("xlink:href", function(d){
                        if(d.taxid) {
                            return "/enzymeportal/taxonomy?entryid=" 
                            + d.taxid 
                            + "&entryname=" 
                            + d.name 
                            + "&AMP;searchparams.type=KEYWORD&searchparams.previoustext=" 
