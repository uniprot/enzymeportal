...
public class SitemapIndexGenerator {
    ...
    public static class Options {
         ...
         * sitemap index file.
         *
         * @param baseUrl All URLs in the generated sitemap(s) should appear
         * under this base URL
        ...
        /**
         * The date formatter, typically configured with a {@link W3CDateFormat.Pattern}
         * and/or a time zone
         */
     ...
     * sitemap index file.
     *
     * @param baseUrl All URLs in the generated sitemap(s) should appear under
     * this base URL
     * @param outFile The sitemap index will be written out at this location
     */
...
//		return this;
//	}
    //customised addUrl method to suit the ep project..
    public SitemapIndexGenerator addUrls(String prefix, String suffix, int count) {
