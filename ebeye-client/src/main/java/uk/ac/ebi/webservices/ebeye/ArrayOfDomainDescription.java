...
/**
 * <p>Java class for ArrayOfDomainDescription complex type.
 * 
...
@XmlType(name = "ArrayOfDomainDescription", namespace = "http://webservice.ebinocle.ebi.ac.uk", propOrder = {
    "domainDescription"
})
public class ArrayOfDomainDescription {

    @XmlElement(name = "DomainDescription", nillable = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the domainDescription property.
     * 
     * <p>
    ...
    public List<DomainDescription> getDomainDescription() {
        if (domainDescription == null) {
            domainDescription = new ArrayList<DomainDescription>();
        }
