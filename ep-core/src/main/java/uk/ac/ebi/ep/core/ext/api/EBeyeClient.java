 ...
 * EB-eye Java client.
 * ====================================================================== */
package uk.ac.ebi.ep.core.ext.api;
...
public class EBeyeClient {
	...
	public static void main(String[] args) {
                //String[] myArgs = {"--listFieldsInformation","uniprot"};
            //Hong
            //String[] myArgs = {"--listDomains"};
            //String[] myArgs = {"--listFieldsInformation","uniprot"};
            //String[] myArgs = {"--listFieldsInformation","intenz"};
            //String[] myArgs = {"--listFieldsInformation","rhea"};
            //String[] myArgs = {"--listFieldsInformation","reactome"};
            //String[] myArgs = {"--listFieldsInformation","chebi"};
            //String[] myArgs = {"--listFieldsInformation","pdbe"};
            //--getResults <domain> <query> <fields> <start> <size>
            //String[] myArgs = {"--getResults","intenz","cGmp","id, name, synonym, systematic_name ","0","100" };
            ...
            //String[] myArgs = {"--getResults","pdbe","cGmp","acc, description, id, keywords, name, status","0","1" };
            //String[] myArgs = {"--getResults","uniprot","acc:P19921","id","0","1" };
            //String[] myArgs = {"--getAllResultsIds","intenz","acc:P19921","id","0","1" };

            //String[] myArgs = {"--getReferencedEntries","uniprot","DCMS_OLICO","pdbe"};
            //String[] myArgs = {"--getDomainsReferencedInEntry","uniprot","DCMS_OLICO"};
            //String[] myArgs = {"--getResultsIds","uniprot","acc:P19921", "0", "1"};
