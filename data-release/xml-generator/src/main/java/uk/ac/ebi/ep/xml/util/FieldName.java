...
public enum FieldName {
    ...
    CHEBI_ID("chebi_id"), PROTEIN_FAMILY_NAME("protein_family_name"), PROTEIN_FAMILY_ID("protein_family_id"), REACTANT("reactant"), RHEA_ID("rhea_id"), UNIPROT_NAME("uniprot_name"), ENTRY_TYPE("entry_type"), FUNCTION("function"), PROTEIN_NAME("protein_name"), GENE_NAME("gene_name"),
