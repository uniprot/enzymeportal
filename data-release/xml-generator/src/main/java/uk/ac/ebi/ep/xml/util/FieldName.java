...
public enum FieldName {
    ...
    RELATED_SPECIES("related_species"),PRIMARY_ACCESSION("primary_accession"),PRIMARY_ORGANISM("primary_organism"), REACTION_MECHANISM("reaction_mechanism"), UNIPROT_FAMILY("uniprot_family");
