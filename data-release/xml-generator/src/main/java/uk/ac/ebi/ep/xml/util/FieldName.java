...
public enum FieldName {
    WITH_TAXONOMY("with_taxonomy"), WITH_PROTEIN_FAMILY("with_protein_family"), WITH_DISEASE("with_disease"), WITH_COFACTOR("with_cofactor"), WITH_PATHWAY("with_pathway"),
    HAS_TAXONOMY("has_taxonomy"), HAS_PROTEIN_FAMILY("has_protein_family"), HAS_DISEASE("has_disease"), HAS_COFACTOR("has_cofactor"), HAS_PATHWAY("has_pathway"),
