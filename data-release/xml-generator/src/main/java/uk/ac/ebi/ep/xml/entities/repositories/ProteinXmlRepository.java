...
public interface ProteinXmlRepository extends JpaRepository<ProteinXml, Long> {
    ...
    //@Query(value = "SELECT u.accession as accession, u.taxId as taxId,u.proteinName as proteinName,u.scientificName as scientificName, u.commonName as commonName,u.sequenceLength as sequenceLength,u.relatedProteinsId as relatedProteinsId, u.function as function, u.entryType as entryType,u.synonymNames as synonymNames,u.expEvidenceFlag as expEvidenceFlag FROM UniprotEntry u WHERE u.accession = :accession")
    // @Query("SELECT u.accession as accession, u.taxId as taxId,u.proteinName as proteinName,u.scientificName as scientificName, u.commonName as commonName,u.relatedProteinsId as relatedProteinsId, u.primaryFunction as primaryFunction, u.entryType as entryType,u.synonymNames as synonymNames,u.expEvidenceFlag as expEvidenceFlag FROM ProteinXml u WHERE u.proteinGroupId = :proteinGroupId")
//    @Transactional(readOnly = true)
//    @Query(value = "SELECT u.accession as accession, u.taxId as taxId,u.proteinName as proteinName,u.scientificName as scientificName, u.commonName as commonName,u.relatedProteinsId as relatedProteinsId, u.primaryFunction as primaryFunction, u.entryType as entryType,u.synonymNames as synonymNames,u.expEvidenceFlag as expEvidenceFlag,"
