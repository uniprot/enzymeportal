...
@NamedQueries({
    ...
    @NamedQuery(name = "EnzymeCatalyticActivity.findByEcNumber", query = "SELECT e FROM EnzymeCatalyticActivity e WHERE e.ecNumber = :ecNumber")})
public class EnzymeCatalyticActivity implements Serializable {
    ...
    public String toString() {
        return "uk.ac.ebi.ep.xml.entities.EnzymeCatalyticActivity[ activityInternalId=" + activityInternalId + " ]";
    }
