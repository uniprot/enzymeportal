...
public abstract class AbstractSitemapGeneratorOptions<THIS extends AbstractSitemapGeneratorOptions<THIS>> {
	...
	public String fileNamePrefix = "sitemap";
	public boolean allowMultipleSitemaps = true;
	public W3CDateFormat dateFormat;
	public int maxUrls = SitemapGenerator.MAX_URLS_PER_SITEMAP;
	public boolean autoValidate = false;
