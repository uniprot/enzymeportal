 ...
 * provide them). <br> The implemented methods are based exclusively on the
 * compound ID. <br> It also implements
 * <code>Comparable</code> to provide a 'natural' order for Compound objects,
